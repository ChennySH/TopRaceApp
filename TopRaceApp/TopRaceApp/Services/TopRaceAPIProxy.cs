...
namespace TopRaceApp.Services
{
    class TopRaceAPIProxy
    {
        ...
        private const string DEV_ANDROID_PHYSICAL_URL = "http://192.168.1.14:20698/TopRaceAPI"; //API url when using physucal device on android
        ...
        private const string DEV_ANDROID_PHYSICAL_PHOTOS_URL = "http://192.168.1.14:20698/Images/"; //API url when using physucal device on android
